...
public class Selector {
    ...
    public static By CLICK_KADIN = By.xpath("//android.widget.TextView[@text=\"Kadın\"]");
    public static By CLICK_PANTS = By.xpath("//android.widget.TextView[@text=\"Pantolon\"]");
    ...
    public static String EMAIL = "batuhan.gengonul@testinium.com";
    public static String PASSWORD = "bthn9807";
